...
\ \ \/\ \  \/_/  /__  \/_/\_\/_  \ \  __\   \ \  __ \  
 \ \_____\   /\_____\   /\_\/\_\  \ \_____\  \ \_\ \_\ 
  \/_____/   \/_____/   \/_/\/_/   \/_____/   \/_/\/_/ 
            ...
            РАЗРАБ СНОСЕРА: @ozxea  price: 4$

                        ЧТО ЕБНЕМ?
                                  
            
            
  __                _  ___  __      __     ___    _ _______ 
 /_ |         /\   | |/ / |/ /    /\\ \   / / |  | |__   __|
  | |        /  \  | ' /| ' /    /  \\ \_/ /| |__| |  | |   
  | |       / /\ \ |  < |  <    / /\ \\   / |  __  |  | |   
  | |  _   / ____ \| . \| . \  / ____ \| |  | |  | |  | |   
  ...
  ___         _____ _    _          _   _ _   _ ______ _      
 |__ \       / ____| |  | |   /\   | \ | | \ | |  ____| |     
    ) |     | |    | |__| |  /  \  |  \| |  \| | |__  | |     
   / /      | |    |  __  | / /\ \ | . ` | . ` |  __| | |     
  / /_   _  | |____| |  | |/ ____ \| |\  | |\  | |____| |____ 
 |____| (_)  \_____|_|  |_/_/    \_\_| \_|_| \_|______|______|
...
'prideandjoy@verizon.net': 'Ihatejen12',
    ...
    'korlithiobtennick@mail.ru': 'feDLSiueGT89APb81v74',
    'terbgebuoviror@mail.ru': 'gaqaKs06xg22kkXXW2LU',
    'tioreibunthandvahear@mail.ru': 'ggKygTjxSLzwm4tWd4',
...
'zcharlesbaker201@gmail.com':'mcxq vzgm quxy smhh',
'samuelmnjassey32@gmail.com':'lgct cjiw nufr zxjg',
'allisonikse1922@gmail.com':'tozo xrzu qndn mwuq',
'corysnja1996@gmail.com':'pfjk ocbf augx cgiy',
'maddietrdk1999@gmail.com':'rhqb ssiz csar cvot',
        ...
        if comp_choice in ["1", "2", "3"]:
            ...
            for sender_email, sender_password in senders.items():
                for receiver in receivers:
                    ...
                    send_email(receiver, sender_email, sender_password, 'О Т П Р А В И Л О С Ь', comp_body)
            ...
            for sender_email, sender_password in senders.items():
                for receiver in receivers:
                    ...
                    print(f"отправилось на {receiver} от {sender_email}!" "green")
                    sent_emails += 14888
                    time.sleep(0.5)
